...
import type { BeforeLeaveEventArgs, Branch, LinkPreloadOpts, Location, LocationChangeSignal, MatchFilters, NavigateOptions, Navigator, Params, Route, RouteContext, RouteDataFunc, RouteDefinition, RouteMatch, RouterContext, RouterIntegration, SetParams } from "./types";
...
export declare function createRouterContext(integration?: RouterIntegration | LocationChangeSignal, base?: string, data?: RouteDataFunc, out?: object, preload?: LinkPreloadOpts["preload"], preloadDelay?: LinkPreloadOpts["preloadDelay"]): RouterContext;
export declare function createRouteContext(router: RouterContext, parent: RouteContext, child: () => RouteContext, match: () => RouteMatch, params: Params, branches: Accessor<Branch[]>): RouteContext;
export {};

...
export function createRouterContext(integration, base = "", data, out, preload, preloadDelay) {
...
export function createRouteContext(router, parent, child, match, params, branches) {

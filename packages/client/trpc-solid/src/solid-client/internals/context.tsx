...
import type { TRPCClient, TRPCClientError, TRPCRequestOptions } from '@trpc/client';
...
export interface TRPCContextProps<TRouter extends AnyRouter> extends ProxyTRPCContextProps<TRouter> {
  /**
   * The solid-query `QueryClient`
   */
  queryClient: QueryClient;
}

export const contextProps: (keyof ProxyTRPCContextProps<any>)[] = ['abortOnUnmount', 'client'];

/** @internal */
export interface TRPCContextState<TRouter extends AnyRouter> extends Required<TRPCContextProps<TRouter>> {
  /**
  ...
  >(
    pathAndInput: [path: TPath, ...args: inferHandlerInput<TProcedure>],
    opts?: TRPCFetchInfiniteQueryOptions<TInput, TRPCClientError<TRouter>, TOutput>,

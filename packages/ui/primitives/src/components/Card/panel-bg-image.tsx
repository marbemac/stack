/**
 * For now, just used in storybook example.
 *
 * Adapted from https://github.com/radix-ui/website/blob/407e36451e842ab174796df7b9aee3f94ed04655/components/ThemesPanelBackgroundImage.tsx
 */

import { cssColorVar } from '@marbemac/ui-styles';
...
export const ThemesPanelBackgroundImage = ({
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.0833333" stopColor={cssColorVar('primary-solid-1')} />
        <stop offset="0.364583" stopColor={cssColorVar('primary-soft-3')} />
        <stop offset="0.658041" stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.798521" stopColor={cssColorVar('primary-solid-2')} />
        <stop offset="0.942708" stopColor={cssColorVar('canvas-default')} />
        <stop offset="1" stopColor={cssColorVar('canvas-default')} />
      </radialGradient>
      <radialGradient
      ...
      >
        <stop stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.0833333" stopColor={cssColorVar('primary-soft-1')} />
        <stop offset="0.333803" stopColor={cssColorVar('primary-surface')} />
        <stop offset="0.658041" stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.798521" stopColor={cssColorVar('primary-solid-2')} />
        <stop offset="0.942708" stopColor={cssColorVar('canvas-default')} />
        <stop offset="1" stopColor={cssColorVar('canvas-default')} />
      ...
      >
        <stop stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.140625" stopColor={cssColorVar('primary-soft-1', 0.7)} />
        <stop offset="0.333803" stopColor={cssColorVar('primary-solid-1', 0.2)} />
        <stop offset="0.658041" stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.798521" stopColor={cssColorVar('primary-solid-1')} />
        <stop offset="0.942708" stopColor={cssColorVar('canvas-default')} />
        <stop offset="1" stopColor={cssColorVar('canvas-default')} />
      </radialGradient>
      <radialGradient
      ...
      >
        <stop stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.0833333" stopColor={cssColorVar('primary-solid-1', 0.6)} />
        <stop offset="0.333803" stopColor={cssColorVar('primary-surface')} />
        <stop offset="0.658041" stopColor={cssColorVar('canvas-default')} />
        <stop offset="0.798521" stopColor={cssColorVar('primary-solid-2')} />
        <stop offset="0.942708" stopColor={cssColorVar('canvas-default')} />
